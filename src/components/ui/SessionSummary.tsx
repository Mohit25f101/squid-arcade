...
const styles: Record<string, React.CSSProperties> = {
  root: { position: "fixed", inset: 0, background: "var(--sq-darker, #050508)", display: "flex", alignItems: "center", justifyContent: "center", zIndex: 100, overflow: "hidden auto", fontFamily: "var(--font-mono-sq, 'Space Mono', monospace)" },
  ...
  historyScore: { fontFamily: "var(--font-bebas, 'Bebas Neue', sans-serif)", fontSize: 18, color: "rgba(255,255,255,0.55)", flexShrink: 0, minWidth: 60, textAlign: "right" },
  emptyHistory: { padding: "20px 16px", fontSize: 12, color: "rgba(255,255,255,0.3)", textAlign: "center" },
  nameBlock: { display: "flex", flexDirection: "column", alignItems: "center", gap: 12, padding: "24px", background: "var(--sq-navy, rgba(13,15,26,0.8))", border: "1px solid rgba(255,255,255,0.08)", borderRadius: 3, backdropFilter: "blur(12px)" },
  ...
  nameChar: { display: "flex", flexDirection: "column", alignItems: "center", gap: 6, fontFamily: "var(--font-bebas, 'Bebas Neue', sans-serif)", fontSize: 48, letterSpacing: "0.1em", lineHeight: 1, width: 64, height: 90, border: "2px solid rgba(255,255,255,0.2)", borderRadius: 2, cursor: "pointer", padding: "4px 0", transition: "border-color 0.15s", justifyContent: "space-between" },
  nameCharActive: {border: "2px solid var(--sq-pink, #FF0066)", boxShadow: "0 0 12px var(--sq-pink, #FF0066)", },
  ...
  saveBtn: { width: "100%", fontFamily: "var(--font-bebas, 'Bebas Neue', sans-serif)", fontSize: 18, letterSpacing: "0.2em", color: "#000", border: "none", padding: "12px 0", borderRadius: 2, cursor: "pointer", marginTop: 4, textTransform: "uppercase" },
  savedBlock: { display: "flex", flexDirection: "column", alignItems: "center", gap: 8, padding: "24px", background: "var(--sq-navy, rgba(13,15,26,0.8))", border: "1px solid rgba(255,255,255,0.08)", borderRadius: 3, backdropFilter: "blur(12px)" },
